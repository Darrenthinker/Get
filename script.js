...
const readingData = [
    ...
    { category: "投资理财", name: "《原则》", level: "推荐" },
    { category: "投资理财", name: "《逃不开的经济周期》", level: "推荐" },
    { category: "投资理财", name: "《置身事内》", level: "推荐" },
    { category: "投资理财", name: "《要钱还是要生活》", level: "推荐" },
    { category: "投资理财", name: "《百万富翁快车道》", level: "推荐" },
    { category: "投资理财", name: "《噪声》", level: "推荐" },
    { category: "投资理财", name: "《思考，快与慢》", level: "推荐" },
    { category: "投资理财", name: "《纳瓦尔宝典》", level: "推荐" },
    { category: "投资理财", name: "《富爸爸，穷爸爸》", level: "推荐" },
    { category: "投资理财", name: "《经济学原理》", level: "推荐" },
    { category: "投资理财", name: "《聪明的投资者》", level: "推荐" },
    { category: "投资理财", name: "《手把手教你读财报》", level: "推荐" },
    { category: "投资理财", name: "《滚雪球：巴菲特和他的财富人生》", level: "推荐" },
    { category: "投资理财", name: "《解读中国经济》", level: "推荐" },
    { category: "投资理财", name: "《穷查理宝典》", level: "推荐" },
    { category: "投资理财", name: "《我的经验与教训》", level: "推荐" },
    { category: "投资理财", name: "《贫穷的本质》", level: "推荐" },
    { category: "投资理财", name: "《有钱人和你想的不一样》", level: "推荐" },
    { category: "投资理财", name: "《最小阻力选择》", level: "推荐" },
    { category: "投资理财", name: "《高效能人士的7个习惯》", level: "推荐" },
    { category: "投资理财", name: "《财富自由之路》", level: "推荐" },
    ...
    { category: "财商情感", name: "网络共享汇", type: "公众号" },
    { category: "财商情感", name: "智多星", type: "公众号" },
    { category: "财商情感", name: "波波来了", type: "公众号" },
    { category: "财商情感", name: "结构学", type: "公众号" },
    { category: "财商情感", name: "张良网创老板会", type: "公众号" },
    { category: "财商情感", name: "无路可套", type: "公众号" },
    { category: "财商情感", name: "为你写一个故事", type: "公众号" },
    { category: "财商情感", name: "懂懂日记", type: "公众号" },
    { category: "财商情感", name: "小路超车", type: "公众号" },
    { category: "财商情感", name: "我就BB怎么了", type: "公众号" },
    { category: "财商情感", name: "张桓投资笔记", type: "公众号" },
    { category: "财商情感", name: "暴疯团队俱乐部", type: "公众号" },
    { category: "财商情感", name: "万小刀", type: "公众号" },
    { category: "财商情感", name: "我会永远在你身后", type: "公众号" },
    { category: "财商情感", name: "地球知识局", type: "公众号" },
    { category: "财商情感", name: "九个泡泡", type: "公众号" },
    { category: "财商情感", name: "拙见", type: "公众号" },
    { category: "财商情感", name: "正解局", type: "公众号" },
    { category: "财商情感", name: "CAP学习网", type: "网站" },
    { category: "财商情感", name: "新媒之家", type: "公众号" },
    { category: "财商情感", name: "8字路口", type: "公众号" },
    { category: "财商情感", name: "马路青年", type: "公众号" },
    { category: "财商情感", name: "大飞码字", type: "公众号" },
    { category: "财商情感", name: "守夜人总司令", type: "公众号" },
    { category: "财商情感", name: "周绪才啊", type: "公众号" },
    { category: "财商情感", name: "阿力推推", type: "公众号" },
    { category: "财商情感", name: "晨晨新思维", type: "公众号" },
    { category: "财商情感", name: "卢松松", type: "公众号" },
    { category: "财商情感", name: "黑帽星球", type: "公众号" },
    { category: "财商情感", name: "境界哥", type: "公众号" },
    { category: "财商情感", name: "灰色哥", type: "公众号" },
    { category: "财商情感", name: "冷门哥", type: "公众号" },
    { category: "财商情感", name: "谦逊哥", type: "公众号" },
    { category: "财商情感", name: "中原偏门哥", type: "公众号" },
    { category: "财商情感", name: "偏门哥讲门道", type: "公众号" },
    { category: "财商情感", name: "朱海涛", type: "公众号" },
    { category: "财商情感", name: "海涛精英会", type: "公众号" },
    { category: "财商情感", name: "陈猎营销", type: "公众号" },
    { category: "财商情感", name: "玩家老高", type: "公众号" },
    { category: "财商情感", name: "这个狼叔不太冷", type: "公众号" },
    { category: "财商情感", name: "酷酷说钱", type: "公众号" },
    { category: "财商情感", name: "安然说钱", type: "公众号" },
    { category: "财商情感", name: "灰产圈", type: "公众号" },
    { category: "财商情感", name: "大熊会", type: "公众号" },
    { category: "财商情感", name: "龙城老板会", type: "公众号" },
    { category: "财商情感", name: "快赚社群", type: "公众号" },
    { category: "财商情感", name: "黑猫社团", type: "公众号" },
    { category: "财商情感", name: "网络创富术", type: "公众号" },
    { category: "财商情感", name: "君不见and", type: "公众号" },
    { category: "财商情感", name: "怪才涂", type: "公众号" },
    { category: "财商情感", name: "CPA学习网", type: "网站" },
    { category: "财商情感", name: "财神大咖", type: "公众号" },
    { category: "财商情感", name: "杰神独家", type: "公众号" },
    { category: "财商情感", name: "嗨推", type: "公众号" },
    { category: "财商情感", name: "陆明明", type: "公众号" },
    { category: "财商情感", name: "峰子笔记", type: "公众号" },
    { category: "财商情感", name: "北魏", type: "公众号" },
    { category: "财商情感", name: "国子派", type: "公众号" },
    { category: "财商情感", name: "网络创业工厂", type: "公众号" },
    { category: "财商情感", name: "财神网络项目", type: "公众号" },
    { category: "财商情感", name: "飞哥传书项目圈", type: "公众号" },
    { category: "财商情感", name: "打工一家亲", type: "公众号" },
    { category: "财商情感", name: "e路发发发", type: "公众号" },
    { category: "财商情感", name: "阿国网络随笔", type: "公众号" },
    { category: "财商情感", name: "灰老大", type: "公众号" },
    { category: "财商情感", name: "老猫随笔", type: "公众号" },
    { category: "财商情感", name: "百态网络", type: "公众号" },
    { category: "财商情感", name: "步天之路", type: "公众号" },
    { category: "财商情感", name: "超常规营销微课堂", type: "公众号" },
    { category: "财商情感", name: "坏坏", type: "公众号" },
    { category: "财商情感", name: "老古董说互联网", type: "公众号" },
    { category: "财商情感", name: "猎赚江湖", type: "公众号" },
    { category: "财商情感", name: "流年领域", type: "公众号" },
    { category: "财商情感", name: "李兄点财", type: "公众号" },
    { category: "财商情感", name: "路哥网事", type: "公众号" },
    { category: "财商情感", name: "九京随笔", type: "公众号" },
    { category: "财商情感", name: "暴风团队俱乐部", type: "公众号" },
    { category: "财商情感", name: "詹伟平", type: "公众号" },
    { category: "财商情感", name: "新媒体之家", type: "公众号" },
    { category: "财商情感", name: "杰神联盟", type: "公众号" },
    { category: "财商情感", name: "阿星网络随笔", type: "公众号" },
    { category: "财商情感", name: "峰少课堂", type: "公众号" },
    { category: "财商情感", name: "四叔创业课", type: "公众号" },
    { category: "财商情感", name: "暴走二狗", type: "公众号" },
    { category: "财商情感", name: "店长智库", type: "公众号" },
    { category: "财商情感", name: "鹏哥微课", type: "公众号" },
    { category: "财商情感", name: "老板逆思维创富学堂", type: "公众号" },
    { category: "财商情感", name: "杨茹运营笔记", type: "公众号" },
    { category: "财商情感", name: "灰邪生", type: "公众号" },
    { category: "财商情感", name: "哲伦一大航海创业", type: "公众号" },
    { category: "财商情感", name: "第九公社", type: "公众号" },
    { category: "财商情感", name: "引流哥666", type: "公众号" },
    { category: "财商情感", name: "奇迹7G", type: "公众号" },
    { category: "财商情感", name: "黄岛主营销", type: "公众号" },
    { category: "财商情感", name: "西域老板会", type: "公众号" },
    { category: "财商情感", name: "史大勇", type: "公众号" },
    { category: "财商情感", name: "低调笔记", type: "公众号" },
    { category: "财商情感", name: "老胡地盘", type: "公众号" },
    { category: "财商情感", name: "粉粉随笔", type: "公众号" },
    { category: "财商情感", name: "mango带你搞副业", type: "公众号" },
    { category: "财商情感", name: "矛盾视界", type: "公众号" },
    { category: "财商情感", name: "毛小白奋斗在深圳", type: "公众号" },
    { category: "财商情感", name: "毛小白plus", type: "公众号" },
    { category: "财商情感", name: "猫爷谈赚", type: "公众号" },
    { category: "财商情感", name: "每天学点自媒体", type: "公众号" },
    { category: "财商情感", name: "苗子分享汇", type: "公众号" },
    { category: "财商情感", name: "苗子思维录", type: "公众号" },
    { category: "财商情感", name: "铭则网络营销", type: "公众号" },
    { category: "财商情感", name: "摸鱼思维", type: "公众号" },
    { category: "财商情感", name: "木木老贼", type: "公众号" },
    { category: "财商情感", name: "逆东黑帽SEO", type: "公众号" },
    { category: "财商情感", name: "牛顿顿顿", type: "公众号" },
    { category: "财商情感", name: "牛哥微课堂", type: "公众号" },
    { category: "财商情感", name: "ONE星球", type: "公众号" },
    { category: "财商情感", name: "旁门左道PPT", type: "公众号" },
    { category: "财商情感", name: "彭楠的创业故事", type: "公众号" },
    { category: "财商情感", name: "偏门哥谈门道", type: "公众号" },
    { category: "财商情感", name: "偏门老杨", type: "公众号" },
    { category: "财商情感", name: "偏门思维", type: "公众号" },
    { category: "财商情感", name: "千虹云课堂", type: "公众号" },
    { category: "财商情感", name: "青年横财发展会", type: "公众号" },
    { category: "财商情感", name: "秦王会", type: "公众号" },
    { category: "财商情感", name: "企业微信", type: "公众号" },
    { category: "财商情感", name: "群响club", type: "公众号" },
    { category: "财商情感", name: "人民路56号", type: "公众号" },
    { category: "财商情感", name: "三八哥", type: "公众号" },
    { category: "财商情感", name: "叁心笔记", type: "公众号" },
    { category: "财商情感", name: "商道天涯", type: "公众号" },
    { category: "财商情感", name: "商道网络随笔", type: "公众号" },
    { category: "财商情感", name: "商梦网校", type: "公众号" },
    { category: "财商情感", name: "商钱", type: "公众号" },
    { category: "财商情感", name: "绅白不白", type: "公众号" },
    { category: "财商情感", name: "生财有术", type: "公众号" },
    { category: "财商情感", name: "圣巩思维说", type: "公众号" },
    { category: "财商情感", name: "拾钱", type: "公众号" },
    { category: "财商情感", name: "石哥思维", type: "公众号" },
    { category: "财商情感", name: "stormzhang", type: "公众号" },
    { category: "财商情感", name: "苏博士无货源开店", type: "公众号" },
    { category: "财商情感", name: "S先生笔记", type: "公众号" },
    { category: "财商情感", name: "他化自在天", type: "公众号" },
    { category: "财商情感", name: "秦安市12345", type: "公众号" },
    { category: "财商情感", name: "秦山频道", type: "公众号" },
    { category: "财商情感", name: "淘客干货", type: "公众号" },
    { category: "财商情感", name: "套路侠是谁", type: "公众号" },
    { category: "财商情感", name: "天策姐说", type: "公众号" },
    { category: "财商情感", name: "天朝私塾", type: "公众号" },
    { category: "财商情感", name: "天朝学子博客", type: "公众号" },
    { category: "财商情感", name: "园南记", type: "公众号" },
    { category: "财商情感", name: "网络创业工场", type: "公众号" },
    { category: "财商情感", name: "网络致富术", type: "公众号" },
    { category: "财商情感", name: "王叔笔记", type: "公众号" },
    { category: "财商情感", name: "王渣男", type: "公众号" },
    { category: "财商情感", name: "微保", type: "公众号" },
    { category: "财商情感", name: "伟东笔记", type: "公众号" },
    { category: "财商情感", name: "稳赚家园", type: "公众号" },
    { category: "财商情感", name: "无本", type: "公众号" },
    { category: "财商情感", name: "无本掌柜", type: "公众号" },
    { category: "财商情感", name: "无极领域", type: "公众号" },
    { category: "财商情感", name: "吴聊创业金融", type: "公众号" },
    { category: "财商情感", name: "无往不利", type: "公众号" },
    { category: "财商情感", name: "五一哥", type: "公众号" },
    { category: "财商情感", name: "项目观察家", type: "公众号" },
    { category: "财商情感", name: "仙人JUMP", type: "公众号" },
    { category: "财商情感", name: "小白创业汇", type: "公众号" },
    { category: "财商情感", name: "小褚网络圈", type: "公众号" },
    { category: "财商情感", name: "小峰创业汇", type: "公众号" },
    { category: "财商情感", name: "晓林侃冷门", type: "公众号" },
    { category: "财商情感", name: "萧七的剑", type: "公众号" },
    { category: "财商情感", name: "小淘学社", type: "公众号" },
    { category: "财商情感", name: "逍遥哥说", type: "公众号" },
    { category: "财商情感", name: "西瓜数据", type: "公众号" },
    { category: "财商情感", name: "新思维PLUS", type: "公众号" },
    { category: "财商情感", name: "杨飞", type: "公众号" },
    { category: "财商情感", name: "阳光保险", type: "公众号" },
    { category: "财商情感", name: "阳光男孩鲁力", type: "公众号" },
    { category: "财商情感", name: "杨子贤UP", type: "公众号" },
    { category: "财商情感", name: "一八玩家", type: "公众号" },
    { category: "财商情感", name: "一本黑", type: "公众号" },
    { category: "财商情感", name: "衣钵先生", type: "公众号" },
    { category: "财商情感", name: "一龙和他伙伴们", type: "公众号" },
    { category: "财商情感", name: "一米聊创业", type: "公众号" },
    { category: "财商情感", name: "营销套路社", type: "公众号" },
    { category: "财商情感", name: "营销学习社", type: "公众号" },
    { category: "财商情感", name: "营销有套", type: "公众号" },
    { category: "财商情感", name: "引流哥", type: "公众号" },
    { category: "财商情感", name: "引流步鲸云", type: "公众号" },
    { category: "财商情感", name: "引流增长哥", type: "公众号" },
    { category: "财商情感", name: "赤无所知", type: "公众号" },
    { category: "财商情感", name: "义乌之狼", type: "公众号" },
    { category: "财商情感", name: "勇哥捞偏门", type: "公众号" },
    { category: "财商情感", name: "用户增长指南", type: "公众号" },
    { category: "财商情感", name: "有范青年", type: "公众号" },
    { category: "财商情感", name: "云梦轩", type: "公众号" },
    { category: "财商情感", name: "运营小助手", type: "公众号" },
    { category: "财商情感", name: "增长女黑客", type: "公众号" },
    { category: "财商情感", name: "张大胖的自留地", type: "公众号" },
    { category: "财商情感", name: "战劲爱分享", type: "公众号" },
    { category: "财商情感", name: "招财大牛猫", type: "公众号" },
    { category: "财商情感", name: "真的好困", type: "公众号" },
    { category: "财商情感", name: "知识星球", type: "公众号" },
    { category: "财商情感", name: "知识星球精选", type: "公众号" },
    { category: "财商情感", name: "中国保险万事通", type: "公众号" },
    { category: "财商情感", name: "中国反传网", type: "公众号" },
    { category: "财商情感", name: "终结诈骗", type: "公众号" },
    { category: "财商情感", name: "周恩俊", type: "公众号" },
    { category: "财商情感", name: "赚课堂", type: "公众号" },
    { category: "财商情感", name: "赚内外博客", type: "公众号" },
    { category: "财商情感", name: "自由领域项目营", type: "公众号" },
    { category: "财商情感", name: "纵横领域", type: "公众号" },
    { category: "财商情感", name: "左道大神", type: "公众号" },
    { category: "财商情感", name: "左哥网创", type: "公众号" },
    { category: "财商情感", name: "坐家一辉", type: "公众号" },
    { category: "财商情感", name: "祖小来", type: "公众号" },
    { category: "财商情感", name: "21K社群888", type: "公众号" },
    { category: "财商情感", name: "58商机网", type: "公众号" },
    { category: "财商情感", name: "8小时外谋发展", type: "公众号" },
    { category: "财商情感", name: "珍妮之吻", type: "公众号" },
    { category: "财商情感", name: "程一", type: "公众号" },
    { category: "财商情感", name: "熙墨爱经", type: "公众号" },
    { category: "财商情感", name: "贪心之路", type: "公众号" },
    { category: "财商情感", name: "金融街李莫愁", type: "公众号" },
    { category: "财商情感", name: "AlphaGirl", type: "公众号" },
    { category: "财商情感", name: "贪心记", type: "公众号" },
    { category: "财商情感", name: "花神妙", type: "公众号" },
    // 房地产
    ...
    // 信用卡
    { category: "信用卡", name: "既明说", type: "公众号" },
    { category: "信用卡", name: "游戏玩卡", type: "公众号" },
    { category: "信用卡", name: "卡卡说钱", type: "公众号" },
    { category: "信用卡", name: "卡妞我们走", type: "公众号" },
    { category: "信用卡", name: "阳叔说", type: "公众号" },
    { category: "信用卡", name: "杨中随笔", type: "公众号" },
    { category: "信用卡", name: "淘房军师", type: "公众号" },
    { category: "信用卡", name: "我不是卡神", type: "公众号" },
    { category: "信用卡", name: "我不是一个随便的人", type: "公众号" },
    { category: "信用卡", name: "以巧克力", type: "公众号" },
    { category: "信用卡", name: "撸房帮666", type: "公众号" },
    { category: "信用卡", name: "修心养信", type: "公众号" },
    { category: "信用卡", name: "撬动人生", type: "公众号" },
    { category: "信用卡", name: "百万的路", type: "公众号" },
    { category: "信用卡", name: "瞎玩机酒卡", type: "公众号" },
    { category: "信用卡", name: "水库卡学堂", type: "公众号" },
    { category: "信用卡", name: "高端卡世界", type: "公众号" },
    { category: "信用卡", name: "玩卡一族", type: "公众号" },
    // 广告营销
    ...
    // 实用工具
    { category: "实用工具", name: "知云阁", type: "公众号" },
    ...
    { category: "实用工具", name: "黑白鲨", type: "公众号" },
    ...
    { category: "实用工具", name: "V视频助手", type: "视频下载" },
    { category: "实用工具", name: "批量下载", type: "视频下载" },
    { category: "实用工具", name: "维棠", type: "视频下载" },
    { category: "实用工具", name: "视频批量下载器", type: "视频下载" },
    { category: "实用工具", name: "讯飞输入法", type: "音频工具" },
    { category: "实用工具", name: "搜狗听写", type: "音频工具" },
    { category: "实用工具", name: "Remove logonow", type: "去水印" },
    { category: "实用工具", name: "去水印软件", type: "去水印" },
    { category: "实用工具", name: "ev录屏", type: "录屏软件" },
    { category: "实用工具", name: "kk录屏", type: "录屏软件" },
    { category: "实用工具", name: "camtasia 9", type: "录屏软件" },
    { category: "实用工具", name: "PR", type: "剪辑软件" },
    { category: "实用工具", name: "AE", type: "剪辑软件" },
    { category: "实用工具", name: "快剪辑", type: "剪辑软件" }
];
...
function initReadingPage() {
    ...
    const categories = ['货代博主', '货代公众号', '诸子百家', '投资理财', '房地产', '信用卡', '广告营销', '财商情感', '实用工具'];
